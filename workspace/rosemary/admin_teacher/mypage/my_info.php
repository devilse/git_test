...
$mb_query = mysqli_query($CONN['rosemary'],"select A.*,B.mb_picture,B.mb_biography,B.mb_education,B.mb_paper from member A, member_teacher B where A.mb_num = '$mb_num' and A.mb_num = B.mb_num");
...
$mb_messenger = $mb_rs['mb_messenger'];
$mb_cafeurl = $mb_rs['mb_cafeurl'];
?>
...
<form name = "info_form" method="post">
	...
	<tr bgcolor="#EFEFEF"> 
		<td align=center width=8%>사진</td>
		<td align=left ><input type="file" name="my_photo"></td>
	</tr>
	<tr bgcolor="#EFEFEF"> 
		<td align=center width=8%>약력</td>
		<td align=left ><input type  = "text" name  = "mb_cafeurl" value = "<?php echo $mb_cafeurl;?>" size=100></td>
	</tr>
	<tr bgcolor="#EFEFEF"> 
		<td align=center width=8%>학력</td>
		<td align=left ><input type  = "text" name  = "mb_cafeurl" value = "<?php echo $mb_cafeurl;?>" size=100></td>
	</tr>
	<tr bgcolor="#EFEFEF"> 
		<td align=center width=8%>논문이나 저서</td>
		<td align=left ><input type  = "text" name  = "mb_cafeurl" value = "<?php echo $mb_cafeurl;?>" size=100></td>
	</tr>
</form>
</table>
