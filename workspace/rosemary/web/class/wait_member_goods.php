...
$tpl->define('content', "skin/class/basic/wait_member_goods.html");
...
$list_qry = "select 
			 ...
			 where 
					A.os_num = B.os_num and A.g_num = B.g_num and A.mbgl_state = 'A' and B.mb_num = '$mb_num'
					order by mbg_regdate desc
					$limit";

$query_number	=	$goods_cnt_A;
if ($query_number) {
