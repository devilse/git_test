...
Browser = {
 ...
 if(Browser.chrome)
    {
     var artists = jQuery(this).find("artist").text();
     var image = jQuery(this).find("image[height='53']").text();

    }
    else if(Browser.ie || Browser.firefox)
    {
     var artists = jQuery(this).find("im\\:artist").text();
     var image = jQuery(this).find("im\\:image[height='53']").text();
    }else
    {
     var artists = jQuery(this).find("artist").text();
     var image = jQuery(this).find("image[height='53']").text();
