<?php include $DOCUMENT_ROOT."/admin_marketer/include/sitemap.php";?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title><?php echo $siteinfo['si_site_name']; ?> 영업자</title>
          ...
          <tr>
            <td width="810"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
					...
					<td width="110" align="left" style="padding:0 5px 0 5px;"><a href="/admin_marketer/"><font color=silver><b>home</b></font></a></td>
...
?>
	...
	<td width="210" valign="top">
		<?php include $DOCUMENT_ROOT."/admin_marketer/include/left_menu.php";?>
	</td>
	<!-- 왼쪽 메뉴 끝 -->	
