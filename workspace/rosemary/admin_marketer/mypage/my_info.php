...
$mb_query = mysqli_query($CONN['rosemary'],"select A.*,B.mb_messenger,B.mb_cafeurl from member A, member_marketer B where A.mb_num = '$mb_num' and A.mb_num = B.mb_num");
...
<form name = "info_form" method="post">
	...
	<tr bgcolor="#EFEFEF"> 
		<td align=center width=8%>메신져</td>
		<td align=left ><input type  = "text" name  = "mb_messenger" value = "<?php echo $mb_messenger;?>" size=100></td>
	</tr>
	<tr bgcolor="#EFEFEF"> 
		<td align=center width=8%>카페주소</td>
