<?php /* Template_ 2.2.7 2013/01/16 15:56:41 C:\rosemary\trunk\src\rosemary\_template\skin\member\basic\refund_list.html 000003976 */ 
...
<div class="sr_head03">
<h3>환불내역</h3>
<p><span> 마이페이지 </span> > <span>환불내역</span></p>
</div>
<!-- LS 우측 컨텐츠  헤드 끝 -->
<!-- LS 우측 컨텐츠 로그인 시작 -->
<div class="sr_body03">
...
<li class="my_tab_01"><h3><a href="./my_pay.php">주문결제내역</a></h3></li>
<li class="my_tab_00"><h3><a href="?">환불내역</a></h3></li>
</ul>
</div>
...
<tr>
<td><p><?php echo $TPL_V1["os_num"]?></p><input onclick="my_pay_info_view('<?php echo $TPL_V1["os_num"]?>','<?php echo $TPL_VAR["page"]?>')" class="white_btn04" type="button" value="상세보기" /></td>
...
<td><?php echo $TPL_V1["rf_sdate"]?></td>
<td><b class="my_red f_s">\<?php echo $TPL_V1["os_amt"]?></b></td>
<td><b class="my_red f_s">\<?php echo $TPL_V1["rf_amt"]?></b></td>
<td><?php echo $TPL_V1["os_state"]?></td>
</tr>
<?php }}?>
<?php }else{?>
<tr>
<td colspan="7">환불한 내역이 없습니다.</td>
</tr>
<?php }?>
</tbody>
</table>
